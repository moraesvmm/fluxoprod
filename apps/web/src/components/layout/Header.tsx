...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-40 flex h-16 shrink-0 items-center gap-x-4 border-b border-border bg-white/80 backdrop-blur-md px-4 sm:gap-x-6 sm:px-6 lg:px-8 shadow-sm">
      <div className="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
        <form className="relative flex flex-1" action="#" method="GET">
          ...
          <input
            id="search-field"
            className="block h-full w-full border-0 py-0 pl-10 pr-0 text-foreground bg-transparent placeholder:text-muted-foreground focus:ring-0 sm:text-sm focus:outline-none"
        ...
        <div className="flex items-center gap-x-4 lg:gap-x-6">
          ...
          <div className="flex items-center gap-x-4">
            <img
              className="h-8 w-8 rounded-full bg-muted object-cover border border-border shadow-sm"
