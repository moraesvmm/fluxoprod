                ...
                return (
                  <tr key={m.user_id} className="hover:bg-muted/20 transition-colors">
                    ...
                    <td className="px-4 py-3">
                      <span className={`inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[11px] font-bold ${isAdmin ? 'bg-amber-500/10 text-amber-600' : 'bg-primary/10 text-primary'}`}>
