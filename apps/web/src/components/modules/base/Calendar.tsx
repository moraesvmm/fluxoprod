      ...
      <div className="p-4 border-b border-border">
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              onClick={goToToday}
              className="px-3 py-1 text-sm font-medium bg-slate-100 hover:bg-slate-200 rounded-md transition-colors"
            >
              Hoje
            </button>
            <button
            ...
            return (
              ...
              >
                <div className="flex items-center justify-between mb-1">
                  <span className={`text-sm font-medium ${isToday ? 'text-primary' : 'text-slate-700'}`}>
                    {i + 1}
                  </span>
                  {dayEvents.length > 0 && (
      ...
      <div className="p-4 border-t border-border">
        <div className="flex items-center gap-4 text-sm">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-slate-600">Aberta/Planejada</span>
          </div>
          <div className="flex items-center gap-2">
