...
export function ActionCard({
  ...
  return (
    ...
    >
      <div>
        <div className="inline-flex rounded-xl bg-primary/10 p-3.5 text-primary ring-1 ring-inset ring-primary/20 mb-4 group-hover:bg-primary group-hover:text-primary-foreground transition-all duration-300 shadow-sm">
