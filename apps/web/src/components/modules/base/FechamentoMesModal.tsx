        ...
        <div className="p-6">
          ...
          <div className="space-y-4">
            <div className="flex items-center p-4 bg-indigo-50 rounded-xl border border-indigo-100">
              ...
              <div>
                <p className="text-sm font-semibold text-muted-foreground uppercase tracking-wider">Faturamento Total</p>
                <p className="text-2xl font-black text-foreground">{formatarMoeda(fechamentoData.faturamento)}</p>
              </div>
            </div>
