...
export function TutorialHelpButton({ moduleKey }: TutorialHelpButtonProps) {
  ...
  return (
    <button
      ...
      className="inline-flex items-center justify-center rounded-md border border-border bg-card text-muted-foreground hover:bg-muted hover:text-foreground h-10 w-10 shadow-sm transition-colors"
