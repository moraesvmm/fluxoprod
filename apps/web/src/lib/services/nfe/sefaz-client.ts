...
export class SefazClient {
   ...
   */
  static async sendSoap(url: string, xmlSigned: string, certPem: string, keyPem: string): Promise<string> {
    const soapEnvelope = `
      <soap12:Envelope xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:soap12="http://www.w3.org/2003/05/soap-envelope">
        <soap12:Body>
          <nfeDadosMsg xmlns="http://www.portalfiscal.inf.br/nfe/wsdl/NFeAutorizacao4">${xmlSigned}</nfeDadosMsg>
        </soap12:Body>
      </soap12:Envelope>
    `.trim();
    ...
    const httpsAgent = new https.Agent({
      cert: certPem,
      key: keyPem,
      rejectUnauthorized: false // Em homologação alguns servidores SEFAZ tem cadeias não confiáveis
    });
