...
const MODULOS_FALLBACK: ModuloData[] = [
  { id: "vendas", key: "vendas", nome: "Vendas & PDV", preco: 99.90, preco_promocional: null, icone: "🛍️", descricao: "Operação completa de frente de caixa e gestão comercial.", features: ["PDV Ágil com integração financeira automática", "Emissão e Gestão de NFe (Prontidão SEFAZ)", "Cálculo de CMV em tempo real por venda"], ordem_exibicao: 0 },
  { id: "crm", key: "crm", nome: "CRM & Nurturing", preco: 129.90, preco_promocional: null, icone: "🎯", descricao: "Gestão avançada de relacionamento e automação de engajamento.", features: ["Gestão de Funil de Vendas", "Inteligência Proativa de Nurturing", "Tour Interativo de Boas-vindas"], ordem_exibicao: 1 },
  { id: "os", key: "os", nome: "Ordem de Serviço", preco: 79.90, preco_promocional: null, icone: "🔧", descricao: "Acompanhamento completo para serviços pontuais.", features: ["OS numerada com status em tempo real", "Atribuição a colaboradores e técnicos", "Tour Interativo de Boas-vindas"], ordem_exibicao: 2 },
  { id: "obras", key: "obras", nome: "Gestão de Obras", preco: 79.90, preco_promocional: null, icone: "🏗️", descricao: "Controle especializado para projetos de longa duração.", features: ["Cronograma por etapas e timeline visual", "Financeiro integrado (Previsto vs Real)", "Tour Interativo de Boas-vindas"], ordem_exibicao: 3 },
  { id: "comissoes", key: "comissoes", nome: "Comissões", preco: 79.90, preco_promocional: null, icone: "💰", descricao: "Gestão transparente das premiações de venda.", features: ["Cálculo automático integrado ao PDV", "Histórico auditável de bonificações", "Tour Interativo de Boas-vindas"], ordem_exibicao: 4 },
  { id: "relatorios", key: "relatorios", nome: "Relatórios", preco: 79.90, preco_promocional: null, icone: "📄", descricao: "Visão analítica avançada sobre a operação do tenant.", features: ["Consolidação de dados cruciais da operação", "DRE Real (Demonstrativo de Resultados) por período", "Análise de Margens e Lucro Líquido"], ordem_exibicao: 5 },
  { id: "rh", key: "rh", nome: "RH & Pessoal", preco: 79.90, preco_promocional: null, icone: "👥", descricao: "Módulo administrativo da equipe.", features: ["Gestão global de colaboradores ativos/desligados", "Upload e Gestão de Documentos Pessoais (RG, CPF, CNH, Contratos)", "Controle de Pagamentos com datas individuais por colaborador"], ordem_exibicao: 6 },
  { id: "financeiro", key: "financeiro", nome: "Gestão Financeira", preco: 119.90, preco_promocional: null, icone: "🏦", descricao: "Controle de fluxo de caixa e inteligência bancária.", features: ["Conciliação Bancária real via arquivo OFX", "Gestão de Contas a Pagar/Receber", "Integração automática com o PDV e CMV"], ordem_exibicao: 7 },
];
