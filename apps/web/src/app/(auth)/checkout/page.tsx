...
const MODULOS_FALLBACK: ModuloData[] = [
  { id: "vendas", key: "vendas", nome: "Vendas & PDV", preco: 99.90, preco_promocional: null, icone: "🛍️", descricao: "Operação completa de frente de caixa e gestão comercial.", features: ["PDV Ágil com caixa por filial e fechamento auditável", "Emissão e Gestão de NFe nativa para Simples Nacional", "Relatórios analíticos de vendas e ticket médio"], ordem_exibicao: 0 },
  { id: "crm", key: "crm", nome: "CRM & Nurturing", preco: 129.90, preco_promocional: null, icone: "🎯", descricao: "Gestão avançada de relacionamento e automação de engajamento.", features: ["Gestão de Funil de Vendas", "Inteligência Proativa de Nurturing", "Relatório analítico de base de clientes"], ordem_exibicao: 1 },
  { id: "os", key: "os", nome: "Ordem de Serviço", preco: 79.90, preco_promocional: null, icone: "🔧", descricao: "Acompanhamento completo para serviços pontuais.", features: ["OS numerada com status em tempo real", "Atribuição a técnicos e técnicos de campo", "Rastreabilidade por Série/IMEI e Diagnóstico"], ordem_exibicao: 2 },
  { id: "obras", key: "obras", nome: "Gestão de Obras", preco: 79.90, preco_promocional: null, icone: "🏗️", descricao: "Controle especializado para projetos de longa duração.", features: ["Cronograma por etapas e timeline visual", "Financeiro integrado (Previsto vs Real)", "Relatórios analíticos com KPIs de orçamentos"], ordem_exibicao: 3 },
  { id: "comissoes", key: "comissoes", nome: "Comissões", preco: 79.90, preco_promocional: null, icone: "💰", descricao: "Gestão transparente das premiações de venda.", features: ["Cálculo automático integrado ao PDV", "Histórico auditável de bonificações", "Relatório de comissões pendentes e pagas"], ordem_exibicao: 4 },
  { id: "relatorios", key: "relatorios", nome: "Relatórios", preco: 79.90, preco_promocional: null, icone: "📄", descricao: "Visão analítica avançada sobre a operação do tenant.", features: ["Interface inteligente com Upsell de módulos", "DRE Real (Demonstrativo de Resultados) por período", "Análise de Margens e Lucro Líquido"], ordem_exibicao: 5 },
  { id: "rh", key: "rh", nome: "RH & Pessoal", preco: 79.90, preco_promocional: null, icone: "👥", descricao: "Módulo administrativo da equipe.", features: ["Gestão global de colaboradores ativos/desligados", "Controle de Pagamentos e Folha Mensal", "Relatório analítico de custos de equipe"], ordem_exibicao: 6 },
  { id: "financeiro", key: "financeiro", nome: "Gestão Financeira", preco: 119.90, preco_promocional: null, icone: "🏦", descricao: "Controle de fluxo de caixa e inteligência bancária.", features: ["Conciliação Bancária real via arquivo OFX", "Gestão de Contas a Pagar/Receber", "Relatórios de Receitas, Despesas e Saldo"], ordem_exibicao: 7 },
];
