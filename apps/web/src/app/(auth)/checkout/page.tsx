...
const MODULOS_FALLBACK: ModuloData[] = [
  { id: "vendas", key: "vendas", nome: "Vendas & PDV", preco: 99.90, preco_promocional: null, icone: "🛍️", descricao: "Operação completa de frente de caixa e gestão comercial.", features: ["PDV Ágil com busca instantânea", "Emissão e Gestão de NFe (Prontidão SEFAZ)", "Cancelamentos e Devoluções com Estorno de Estoque"], ordem_exibicao: 0 },
  ...
  { id: "relatorios", key: "relatorios", nome: "Relatórios", preco: 79.90, preco_promocional: null, icone: "📄", descricao: "Visão analítica avançada sobre a operação do tenant.", features: ["Consolidação de dados cruciais da operação", "Relatórios Analíticos de Vendas e Performance", "Tour Interativo de Boas-vindas"], ordem_exibicao: 5 },
