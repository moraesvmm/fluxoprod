...
const MODULOS_FALLBACK: ModuloData[] = [
  { id: "vendas", key: "vendas", nome: "Vendas & PDV", preco: 99.90, preco_promocional: null, icone: "🛍️", descricao: "Operação completa de frente de caixa e gestão comercial.", features: ["PDV Ágil com integração financeira automática", "Emissão e Gestão de NFe (Prontidão SEFAZ)", "Relatórios analíticos de vendas e ticket médio"], ordem_exibicao: 0 },
