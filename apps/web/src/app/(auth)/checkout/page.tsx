...
const MODULOS_FALLBACK: ModuloData[] = [
  { id: "crm", key: "crm", nome: "CRM & Nurturing", preco: 129.90, preco_promocional: null, icone: "🎯", descricao: "Gestão avançada de relacionamento e automação de engajamento.", features: ["Gestão de Funil de Vendas", "Inteligência Proativa de Nurturing", "Tour Interativo de Boas-vindas"], ordem_exibicao: 0 },
  { id: "os", key: "os", nome: "Ordem de Serviço", preco: 79.90, preco_promocional: null, icone: "🔧", descricao: "Acompanhamento completo para serviços pontuais.", features: ["OS numerada com status em tempo real", "Atribuição a colaboradores e técnicos", "Tour Interativo de Boas-vindas"], ordem_exibicao: 1 },
  { id: "obras", key: "obras", nome: "Gestão de Obras", preco: 79.90, preco_promocional: null, icone: "🏗️", descricao: "Controle especializado para projetos de longa duração.", features: ["Cronograma por etapas e timeline visual", "Financeiro integrado (Previsto vs Real)", "Tour Interativo de Boas-vindas"], ordem_exibicao: 2 },
  { id: "comissoes", key: "comissoes", nome: "Comissões", preco: 79.90, preco_promocional: null, icone: "💰", descricao: "Gestão transparente das premiações de venda.", features: ["Cálculo automático integrado ao PDV", "Histórico auditável de bonificações", "Tour Interativo de Boas-vindas"], ordem_exibicao: 3 },
  { id: "relatorios", key: "relatorios", nome: "Relatórios", preco: 79.90, preco_promocional: null, icone: "📄", descricao: "Visão analítica avançada sobre a operação do tenant.", features: ["Consolidação de dados cruciais da operação", "Visão estratégica macro para diretores", "Tour Interativo de Boas-vindas"], ordem_exibicao: 4 },
  { id: "rh", key: "rh", nome: "RH & Pessoal", preco: 79.90, preco_promocional: null, icone: "👥", descricao: "Módulo administrativo da equipe.", features: ["Gestão global de colaboradores ativos/desligados", "Cadastro e atribuição de cargos funcionais", "Tour Interativo de Boas-vindas"], ordem_exibicao: 5 },
];
