...
const MODULOS_FALLBACK: ModuloData[] = [
  ...
  { id: "os", key: "os", nome: "Ordem de Serviço", preco: 79.90, preco_promocional: null, icone: "🔧", descricao: "Acompanhamento completo para serviços pontuais.", features: ["OS numerada com status em tempo real", "Atribuição a colaboradores e técnicos", "Relatórios analíticos com KPIs de produtividade"], ordem_exibicao: 2 },
