...
const MODULOS_FALLBACK: ModuloData[] = [
  ...
  { id: "rh", key: "rh", nome: "RH & Pessoal", preco: 79.90, preco_promocional: null, icone: "👥", descricao: "Módulo administrativo da equipe.", features: ["Gestão global de colaboradores ativos/desligados", "Cadastro e atribuição de cargos funcionais", "Tour Interativo de Boas-vindas"], ordem_exibicao: 6 },
