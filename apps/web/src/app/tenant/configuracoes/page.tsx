          ...
          <div className="bg-white border border-border rounded-xl p-6 shadow-sm">
            ...
            <div className="mt-8 border-t border-slate-100 pt-6">
              ...
              <div className="grid grid-cols-1 gap-6 sm:grid-cols-3">
                ...
                <div>
                  <label className="block text-sm font-medium text-slate-700">Código IBGE do Município</label>
                  <input
                    type="text"
                    maxLength={7}
                ...
                <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                  ...
                  <div className="sm:col-span-2 border-t border-slate-100 pt-4 mt-2">
                    <div className="flex items-center justify-between mb-4">
                      <h4 className="text-sm font-bold text-slate-900 uppercase tracking-wider">Ambiente de Emissão Nativa</h4>
                      <div className="flex items-center gap-2 bg-slate-100 p-1 rounded-lg">
                        <button
                          onClick={() => setFiscalForm({ ...fiscalForm, nfe_ambiente: "homologacao" })}
                          className={`px-3 py-1 rounded-md text-[10px] font-bold uppercase transition-all ${fiscalForm.nfe_ambiente === "homologacao" ? "bg-white shadow-sm text-primary" : "text-slate-500"}`}
                        >
                          Homologação
                        </button>
                        <button
                          onClick={() => setFiscalForm({ ...fiscalForm, nfe_ambiente: "producao" })}
                          className={`px-3 py-1 rounded-md text-[10px] font-bold uppercase transition-all ${fiscalForm.nfe_ambiente === "producao" ? "bg-white shadow-sm text-primary" : "text-slate-500"}`}
                        >
                          Produção
                        </button>
                      </div>
                    ...
                    <div className="mt-8 border-t border-slate-100 pt-6">
                      <h4 className="text-sm font-bold text-slate-900 uppercase tracking-wider mb-4 flex items-center gap-2">
                        <CheckCircle2 className="h-4 w-4 text-green-500" /> Certificado e Credenciais
                      </h4>
