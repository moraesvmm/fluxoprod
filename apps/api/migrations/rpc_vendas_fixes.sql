-- Migração para corrigir a função tenant_listar_vendas
-- Muda o retorno de TABLE para JSONB para evitar erros de array duplo e deserialização 
-- e converte as chaves para baterem exatamente com a interface Venda do frontend
