...
- [ ] Executar `supabase_rpc.sql` no Supabase SQL Editor
- [ ] Executar `migrations_expansion.sql` no Supabase SQL Editor
- [ ] Para schemas existentes, executar `migrar_schema_existente()` para cada um
- [ ] Criar usuário-master via script seed
- [ ] Configurar variáveis de ambiente (.env.local)
- [ ] Testar provisionamento de nova empresa
- [ ] Testar ativação de módulos via admin
- [ ] Testar fluxo completo de venda (PDV)
- [ ] Validar trigger de estoque
- [ ] Validar trigger de comissão
- [ ] Validar trigger de histórico de OS
- [ ] Validar RLS (testar com usuários de empresas diferentes)
- [ ] Validar feature flags (tentar acessar módulo inativo)
