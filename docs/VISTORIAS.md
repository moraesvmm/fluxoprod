...
- Revisao financeira: edicao, exclusao logica e conciliacao OFX usam RPCs por filial; operacoes legadas de escrita foram revogadas para `authenticated` e a conciliacao nao confirma sucesso quando a gravacao falha.
